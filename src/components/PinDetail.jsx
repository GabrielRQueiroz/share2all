...
const PinDetail = ({ user }) => {
	...
	if (!pinDetail) {
		return <Spinner fullScreen message='Showing pin' />;
	}
			...
			{pinDetail && (
				...
				>
					...
					<div className='w-full p-5 flex-1 xl:min-w-620'>
						...
						<div className='flex flex-wrap mt-6 gap-3 justify-center md:justify-start'>
							<div className='flex flex-grow justify-between w-screen md:w-auto'>
								<Link to={`/user-profile/${user._id}`}>
									<img
										src={user.image}
										className='w-10 h-10 rounded-full cursor-pointer sm:self-center mr-2'
										alt='user-profile'
									/>
								</Link>
								<input
